%experiment:
%Adjust users from 1 to 7
%This is for small scale experiment
%Quota is 3
%25 Servers
%Number of freq locations for each user is fixed to 3
...
numberOfUsers = 8; % the number of users in each layout
minVisitedLocations = 3;
...
filenamePrefix = sprintf('smallScale2_%d_S%d_L%d_U%d', sampleSize, StorageNodeSize, LocationSize, numberOfUsers);
