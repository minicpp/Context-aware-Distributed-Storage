%experiment:
% The probability of residing at one out of two places
% This is for small scale experiment
% Number of users at each layout is 4
% Each user has 2 frequently visited places
% k=4, r=4
%Quota is 3
%20 Servers
%To make it faster, we set 30 samples

% post process in java: adjust probability, adjust write and read MB for
% each operation
...
filenamePrefix = sprintf('smallScale4_%d_S%d_L%d_U%d', sampleSize, StorageNodeSize, LocationSize, numberOfUsers);
